            ...
            <div>
              <div className="flex items-center gap-2">
                <h2 className="font-bold text-base tracking-tight text-foreground">
                  {currentSessionTitle || 'Chat Assistant'}
                </h2>
              ...
              <FadeIn className="h-full flex flex-col justify-center items-center py-12 space-y-8 text-center">
                ...
                <div>
                  <h3 className="text-2xl font-bold tracking-tight text-foreground">
                    {currentSessionTitle || 'Start a New Conversation'}
                  </h3>
                ...
                <FadeIn key={msg.id} direction="up" duration={0.3} className="space-y-3">
                  <div className={`flex gap-4 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                    ...
                    <div className={`max-w-[80%] space-y-3 ${msg.role === 'user' ? 'order-first' : ''}`}>
                      {/* Message Card */}
                      <Card
                        className={`p-5 rounded-2xl text-base leading-relaxed font-medium ${
                          msg.role === 'user'
            ...
            <div className="max-w-4xl mx-auto relative">
              ...
              <div className="relative rounded-2xl border border-border/80 bg-card shadow-lg p-4 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/20 transition-all">
                <Textarea
                  ...
                  className="min-h-[60px] max-h-[140px] border-0 bg-transparent shadow-none focus-visible:ring-0 resize-none py-2 px-3 text-base font-medium placeholder:text-muted-foreground/60"
                  rows={1}
                />
                ...
                <div className="flex items-center justify-between px-2 pt-2 border-t border-border/40">
                  ...
                  <Button
                    ...
                    size="default"
                    className="gap-2 shadow-lg shadow-primary/25 px-6 h-10 font-bold text-sm rounded-xl"
                  >
                    {chatMutation.isPending ? (
